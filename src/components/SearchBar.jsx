const SearchBar = ({ props }) => {
  ...
  return (
    <a href={props.url} class="bg-zinc-200 dark:bg-zinc-900 p-4 rounded-md group hover:shadow-lg">
      <div class="relative">
        ...
        <article class="flex flex-col gap-2">
          ...
          <p class="flex flex-wrap gap-2">
            {props.frontmatter.tags.map(tag =>
              <span class="bg-zinc-100 dark:bg-zinc-800 p-2 rounded-md">{tag}</span>)
            }
          </p>
        </article>
      </div>
